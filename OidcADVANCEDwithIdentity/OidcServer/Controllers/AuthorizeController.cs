...
using OidcServer.AuthorizationClient;
...
namespace OidcServer.Controllers
{
    ...
    {
        public const int TOKEN_RESPONSE_VALID_SECONDS = 1200; // 20 minutes
        public const int CODE_RESPONSE_VALID_SECONDS = 60 * 5;
        ...
        public IActionResult AuthorizeAsync(AuthenticationRequestModel authenticateRequest, string user, string[] scopes)
        {
            ...
            if (!codeStorage.TryAddCode(code, new CodeStorageValue()
            {
                ...
                ExpiryTime = DateTime.Now.AddSeconds(CODE_RESPONSE_VALID_SECONDS),
        ...
        public IActionResult GetTokenAsync(string grant_type, string? code, string? refresh_token, string redirect_uri)
        {
            if (grant_type == "authorization_code")
            {
                ...
                var result = new AuthenticationResponseModel()
                {
                    ...
                    ExpiresIn = TOKEN_RESPONSE_VALID_SECONDS // valid in 30 seconds
                };
            ...
            else if (grant_type == "refresh_token")
            {
                ...
                var result = new RefreshResponseModel()
                {
                    ...
                    TokenType = "Bearer",
                    RefreshToken = refreshToken,
                    ExpiresIn = TOKEN_RESPONSE_VALID_SECONDS // valid in 20 minutes
                };
