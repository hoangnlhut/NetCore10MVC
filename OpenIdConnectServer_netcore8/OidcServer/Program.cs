...
namespace OidcServer
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddSingleton<Repository.IUserRepository, Repository.InMemoryUserRepository>();
            builder.Services.AddSingleton<Repository.ICodeItemRepository, Repository.CodeItemRepository>();
